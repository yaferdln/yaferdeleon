        ...
        <div key={index} className="bg-slate-800/40 rounded px-8 py-4">
          ...
          <div className="flex flex-wrap gap-3 justify-start">
            {skill.items.map((item, idx) => (
              <span
                key={idx}
                className="inline-flex items-center bg-slate-800/40 rounded-full px-4 py-2 mb-3 text-sm font-medium text-slate-200 transition-colors duration-300 hover:bg-teal-400 hover:text-slate-900 cursor-default select-none"
              >
